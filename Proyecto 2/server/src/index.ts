...
function createAST(ast:any):string {
    let code:string = "";
    let cont = 1;
...
ruta.get("/codeArbol", (req:any, res:any) => {
    ...
    fs.writeFile("graphviz.html", codigo, function(err:any) {
        if (err) {
